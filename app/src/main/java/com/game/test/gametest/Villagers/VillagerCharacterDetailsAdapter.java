...
public class VillagerCharacterDetailsAdapter extends ArrayAdapter<Integer> {

    private String TAG = "/VillagerCharacterDetailsAdapter";
    private final Context context;
    private final List<Integer> charStats;
    ...
    public VillagerCharacterDetailsAdapter(Activity context, List<String> statNames, List<Integer> charStats, List<Integer> itemStats) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i(TAG, "itemCharStat: " + itemStats.get(position));
